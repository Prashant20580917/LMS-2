...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>¡Empieza a aprender hoy! Únete ahora para
         acceder a cursos dirigidos por expertos y 
         mejorar tus habilidades a tu propio ritmo.</p>
